...
#### The current version can be found at this link: https://github.com/kos234/Student-s-diary/releases/download/1.4.6/Student.s.diary.1.4.6.Alpha.apk
...
#### Приложение можно скачать по этой ссылке: https://github.com/kos234/Student-s-diary/releases/download/1.4.6/Student.s.diary.1.4.6.Alpha.apk
