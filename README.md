...
![screenshot of timetables](images/2020-02-17-18-22-02.png)
...
![screenshot of timetables_add](images/Screenshot-20200901-174913-com-example-kos.jpg)

### **Функционал меню времени:**
#### Стандартный TimePicker. Снача выбираете часы, после минуты. 
![screenshot of timetables_add](images/Screenshot-20200901-174919-com-example-kos.jpg)
...
![screenshot of diary](images/Screenshot-20200902-084425-com-example-kos.jpg)
...
![screenshot of teachers](images/2020-02-17-19-23-08.png)

### **Функционал экрана добавление, он же экран редактирования:**
#### 1) Поле имени учителя, преподавателя
#### 2) Поле названия предмета которое он преподаёт 
#### Если все поля были пусты (то есть вы ничего не вводили) запишутся данные по умолчанию, которые вы могли видеть в скрытом режиме
![screenshot of teachers_add](images/2020-02-17-19-30-48.png)
...
![screenshot of grades](images/Screenshot-20200902-084530-com-example-kos.jpg)
...
![screenshot of grades](images/Screenshot-20200831-143404-com-example-kos.jpg)
...
![screenshot of conf add](images/2020-02-19-15-24-34.png)
...
![screenshot of timetables_add](images/2020-02-19-15-30-36-2.png)
...
#### 4) Кнопка плей, пауза
![screenshot of conf voice](images/2020-02-19-17-52-53.png)

### **Функционал экрана подтверждения с помощью фотографии:**
#### 1) Сама фотография
#### 2) Кнопка закрытия диалога
![screenshot of conf photo](images/2020-02-20-18-41-44.png)
...
![screenshot of help](images/Screenshot-20200908-195307-com-example-kos.jpg)
...
![screenshot of errors](images/2020-02-27-22-12-43.png)
...
![screenshot of settings](images/Screenshot-20200902-171839-com-example-kos.jpg)

### **Примеры:**
#### 1)
![screenshot of example one](images/2020-02-19-17-43-50.png)
![screenshot of example one](images/2020-02-19-17-42-00.png)

#### 2)
![screenshot of example two](images/2020-02-19-17-48-28.png)
![screenshot of example two](images/2020-02-19-17-49-29.png)

### **Меню выбора файла**
#### 1) Перемещение по папкам
#### 2) Выбор архива. Вы должны выбрать именно архив с данными
![screenshot of choose color](images/Screenshot_20200908_202624_com.example.kos.jpg)
...
![screenshot of custom theme](images/Screenshot_20200902_172000_com.example.kos.jpg)

### **При нажатие на блоки с 3 по 27 открывается блок выбора способа указания цвета, вот его функционал:**
#### 1) Указать HEX-код 
#### 2) Выбрать цвет самому
![screenshot of choose color](images/2020-02-19-18-37-17.png)

#### Если была нажата 1 кнопка, откроется меню:
#### 1) Поле для HEX-кода
![screenshot of hex color](images/2020-02-19-18-37-56-2.png)
...
#### 3) Предыдущий цвет
#### 4) Итоговый цвет
![screenshot of color](images/2020-02-19-18-39-21.png)
